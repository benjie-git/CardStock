...
if wx.Platform == "__WXMAC__":
    pyinstall("--onedir --clean -y --windowed -s -n standalone standalone.py")
    os.mkdir("dist/containerDir")
    shutil.move("dist/standalone.app", "dist/containerDir/")
    pyinstall("--onedir --clean -y --windowed -s --exclude-module PyInstaller --add-data dist/containerDir:. -n CardStock_Designer designer.py")
    pyinstall("--onedir --clean -y --windowed -s -n CardStock_Viewer viewer.py")
