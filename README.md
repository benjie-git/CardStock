...
Running CardStock from source requires Python 3.7 or newer (3.9+ recommended), and wxPython 4.0 or newer (4.1+ recommended).
...
6. or run build.py to create your own standalone applications for the Designer and Viewer applications.
